...
function getProductsByCategory(categoryName = "", serviceName = "") {
  ...
  if (cat.includes("nail") || svc.includes("nail") || svc.includes("móng"))
    return PRODUCT_CATALOG["Nail"];
  if (
    cat.includes("massage") ||
    svc.includes("massage") ||
    svc.includes("đá nóng") ||
    svc.includes("body")
  )
    return PRODUCT_CATALOG["Massage"];
  if (cat.includes("wax") || svc.includes("wax") || svc.includes("triệt"))
    return PRODUCT_CATALOG["Waxing"];
  if (
    cat.includes("facial") ||
    svc.includes("facial") ||
    svc.includes("da mặt") ||
...
function getDefaults(name = "") {
  ...
  if (
    ...
    return {
      ...
      observations:
        "Móng khách hơi khô, da quanh móng hơi khô. Đã tư vấn dưỡng ẩm và tránh tiếp xúc hóa chất. Khách thích màu hồng nhẹ nhàng.",
      recs: [
        "Dưỡng ẩm da tay và móng 2-3 lần/ngày",
        "Tránh ngâm tay trong nước quá nóng hoặc hóa chất",
        "Nên quay lại sau 3 - 4 tuần để làm mới",
        "Sử dụng dầu dưỡng móng trước khi đi ngủ",
      ],
      specs: [
  ...
  if (
    ...
    return {
      ...
      observations:
        "Vùng cơ thang bả vai trái bị co cứng nhiều do ngồi lâu. Đã thực hiện giải cơ sâu 20 phút.",
      recs: [
        "Uống 500ml nước ấm sau massage",
        "Tập giãn cơ vai nhẹ mỗi 2 tiếng",
        "Hẹn lịch sau 1 tuần phục hồi",
      ],
      specs: [
        {
          label: "Vùng điều trị",
          field: "beforeCond",
          value: "Đau mỏi vai gáy",
        },
  ...
  if (
    ...
    return {
      ...
      products: [
        ...
        {
          name: "Mặt nạ đất sét trà xanh",
          desc: "Làm dịu da và se khít lỗ chân lông",
        },
      ],
      beforeCond: "Da sạm, nhiều sợi bã nhờn",
      afterResult: "Sáng mịn, sạch sâu thông thoáng",
      observations:
        "Da khách hàng thuộc nhóm da hỗn hợp thiên dầu, vùng chữ T nhiều bã nhờn. Đã điện di tinh chất làm sáng da.",
      recs: [
        "Thoa kem chống nắng mỗi ngày",
        "Cấp ẩm đầy đủ bằng toner/serum dịu nhẹ",
        "Nên làm dịch vụ chăm sóc da định kỳ mỗi 2 tuần",
      ],
      specs: [
        {
          label: "Tình trạng da",
          field: "beforeCond",
          value: "Da hỗn hợp, xỉn màu",
        },
  ...
  if (
    ...
    return {
      ...
      products: [
        {
          name: "Dầu gội sinh học organic L'Oreal",
          desc: "Phục hồi tóc hư tổn",
        },
        {
          name: "Tinh dầu bưởi kích thích mọc tóc",
          desc: "Chiết xuất tự nhiên",
        },
        {
          name: "Serum dưỡng Keratin phục hồi",
          desc: "Bảo vệ tóc trước nhiệt độ sấy",
        },
      ],
      beforeCond: "Tóc xơ rối, hư tổn nhẹ",
      afterResult: "Bóng mượt, phom tóc bồng bềnh",
      observations:
        "Tóc khách có dấu hiệu xơ ở phần ngọn do nhiệt. Đã bù đắp dưỡng chất Keratin sâu tại bước phục hồi.",
      recs: [
        "Hạn chế sấy tóc ở nhiệt độ quá cao tại nhà",
        "Sử dụng dầu xả/dầu hấp phục hồi tóc 2-3 lần/tuần",
        "Dùng tinh dầu dưỡng bảo vệ ngọn tóc trước ánh nắng",
      ],
      specs: [
        {
          label: "Tình trạng tóc",
          field: "beforeCond",
          value: "Tóc xơ rối, hư tổn nhẹ",
        },
  ...
  return {
    ...
    recs: [
      "Chăm sóc tại nhà theo hướng dẫn cơ bản",
      "Bảo vệ vùng da tránh nắng trực tiếp",
    ],
    specs: [
...
/* ─────────────────────────────────────────
   ...
   QUICK SAMPLE TEMPLATES FOR BEFORE & AFTER
   ───────────────────────────────────────── */
const QUICK_BEFORE_SAMPLES = {
  Waxing: [
    "Lông rậm, thô cứng, nang lông sâu",
    "Lông mọc lại sần mẫn, ngứa nhẹ",
    "Da khô, nhạy cảm vùng wax",
    "Lông mọc ngược, nổi nấc nang lông",
  ],
  Nail: [
    "Móng khô giòn, da quanh móng thô sần",
    "Móng mỏng yếu, có vệt trầy xước",
    "Có lớp sơn gel cũ bị tróc",
    "Phom móng chưa đều, da tay khô",
  ],
  Massage: [
    "Đau mỏi vùng cổ vai gáy kéo dài",
    "Căng cứng cơ bả vai và thắt lưng",
    "Cơ thể mệt mỏi, uể uải, thiếu ngủ",
    "Khí huyết kém lưu thông, tê nhức tay chân",
  ],
  Facial: [
    "Da khô thiếu ẩm, bề mặt thô ráp",
    "Da dầu mụn ẩn nhiều vùng T-zone",
    "Da xỉn màu, xạm nắng, không đều màu",
    "Lỗ chân lông to, nhiều mụn đầu đen",
  ],
  default: [
    "Bề mặt thô sần, thiếu độ ẩm",
    "Cơ thể căng thẳng, mệt mỏi",
    "Cần chăm sóc và phục hồi chuyên sâu",
    "Tình trạng bình thường, da nhạy cảm nhẹ",
  ],
};

const QUICK_AFTER_SAMPLES = {
  Waxing: [
    "Sạch lông 100%, da mịn màng, không rát",
    "Triệt sạch nang lông thô, da sáng đều",
    "Làm dịu da hoàn hảo, hết sần mẫn",
    "Lỗ chân lông se khít, thoáng sạch",
  ],
  Nail: [
    "Móng tròn đẹp, sơn gel bóng bền màu",
    "Phom móng chuẩn, da mềm mại mượt mà",
    "Móng chắc khỏe, viền da gọn gàng",
    "Màu sơn chuẩn sắc, độ bóng cao",
  ],
  Massage: [
    "Giải cơ vai gáy, giảm đau mỏi 90%",
    "Cơ thể nhẹ nhõm, thư thái toàn thân",
    "Khí huyết lưu thông tốt, dễ chịu",
    "Các nhóm cơ mềm mại, hết co thắt",
  ],
  Facial: [
    "Da căng bóng, ẩm mượt, mịn màng",
    "Sạch sâu lỗ chân lông, hết dầu thừa",
    "Da hồng hào, tươi trẻ, mờ thâm",
    "Bề mặt da mịn màng, sáng khỏe",
  ],
  default: [
    "Kết quả cải thiện rõ rệt, mịn màng",
    "Khách hàng rất hài lòng với kết quả",
    "Phục hồi da/cơ thể mượt mà, săn chắc",
    "Hoàn thiện dịch vụ chuẩn phác đồ",
  ],
};

function getQuickBeforeSamples(name = "") {
  const n = String(name || "").toLowerCase();
  if (n.includes("wax") || n.includes("triệt"))
    return QUICK_BEFORE_SAMPLES["Waxing"];
  if (n.includes("nail") || n.includes("móng") || n.includes("gel"))
    return QUICK_BEFORE_SAMPLES["Nail"];
  if (n.includes("massage") || n.includes("body") || n.includes("vai gáy"))
    return QUICK_BEFORE_SAMPLES["Massage"];
  if (n.includes("facial") || n.includes("da") || n.includes("mặt"))
    return QUICK_BEFORE_SAMPLES["Facial"];
  return QUICK_BEFORE_SAMPLES["default"];
}

function getQuickAfterSamples(name = "") {
  const n = String(name || "").toLowerCase();
  if (n.includes("wax") || n.includes("triệt"))
    return QUICK_AFTER_SAMPLES["Waxing"];
  if (n.includes("nail") || n.includes("móng") || n.includes("gel"))
    return QUICK_AFTER_SAMPLES["Nail"];
  if (n.includes("massage") || n.includes("body") || n.includes("vai gáy"))
    return QUICK_AFTER_SAMPLES["Massage"];
  if (n.includes("facial") || n.includes("da") || n.includes("mặt"))
    return QUICK_AFTER_SAMPLES["Facial"];
  return QUICK_AFTER_SAMPLES["default"];
}
...
export default function TreatmentNotesV2() {
  ...
  const [filterCustomerOnly, setFilterCustomerOnly] =
    useState(!!customerIdParam);
  ...
  useEffect(() => {
    if (selectedNote?.follow_up_appointment_id) {
      axiosClient
        .get(`/appointments/${selectedNote.follow_up_appointment_id}`)
        .then((r) => {
  ...
  const def = useMemo(
    () => getDefaults(selectedNote?.ServiceName),
    [selectedNote],
  );
  ...
  const toggleAIInsights = async () => {
    ...
    try {
      ...
      const res = await axiosClient.get(
        `/v2/treatment-notes/customers/${customer.CustomerId}/ai-insights`,
      );
    ...
    try {
      ...
      if (aiData) {
        ...
        if (aiData.suggested_follow_up_days) {
          ...
          const foundSvc = services.find(
            (s) =>
              cleanSvcName.includes(s.ServiceName.toLowerCase()) ||
              s.ServiceName.toLowerCase().includes(cleanSvcName),
          );
          if (foundSvc) {
          ...
          toast$(
            `🪄 AI khuyên tái khám sau ${aiData.suggested_follow_up_days} ngày (${d.toLocaleDateString("vi-VN")}): ${aiData.suggested_follow_up_reason || "Tái khám theo dõi phác đồ"}`,
            "info",
          );
        }
      ...
      toast$(
        err.response?.data?.message ||
          err.message ||
          "Không thể sinh ghi chú bằng AI.",
        "error",
      );
    } finally {
  ...
  const applyAIBooking = () => {
    ...
    const { serviceId, serviceName, daysFromNow, notes } =
    ...
    const defaultKtvId =
      selectedNote?.technician_id || employees[0]?.EmployeeId;
    setBookKtv(String(defaultKtvId));
    const ktvObj = employees.find(
      (e) => String(e.EmployeeId) === String(defaultKtvId),
    );
  ...
  const parseBold = (str) => {
    ...
    return parts.map((part, i) =>
      i % 2 === 1 ? (
        <strong key={i} className="tn-ai-strong">
          {part}
        </strong>
      ) : (
        part
  ...
  const renderAiMarkdown = (text) => {
    ...
    return lines.map((line, idx) => {
      ...
      if (trimmed.startsWith("###")) {
        ...
        else if (headingText.includes("TIẾN TRÌNH"))
          colorClass = "tn-ai-h3--progress";
        else if (headingText.includes("UP-SELL"))
          colorClass = "tn-ai-h3--upsell";

        return (
          <h4 key={idx} className={`tn-ai-heading ${colorClass}`}>
            {headingText}
          </h4>
        );
      }
  ...
  useEffect(() => {
    axiosClient
      .get("/auth/me")
      .then((r) => setUserRole(r.data?.data?.RoleName || "Technician"))
      .catch(() => {});
  }, []);
    ...
    (async () => {
      try {
        ...
        if (activeApptId) {
          try {
            const r = await axiosClient.get(
              `/v2/treatment-notes/appointments/${activeApptId}${serviceIdParam ? `?serviceId=${serviceIdParam}` : ""}`,
            );
            ...
            if (activeNote) {
              ...
              try {
                const apptR2 = await axiosClient.get(
                  `/technician/appointments/${activeApptId}`,
                );
                const apptData = apptR2.data?.data || {};
          ...
          if (!activeNote) {
            try {
              const apptR = await axiosClient.get(
                `/technician/appointments/${activeApptId}`,
              );
              ...
              const serviceId = serviceIdParam
                ...
                : servicesList[0]?.ServiceId || 1;
              const technicianId = fullAppt.TechnicianId || 1;
              customerId = fullAppt.CustomerId;
              // Lưu thông tin appointment để kiểm tra Combo
              setCurrentAppointment({ ...fullAppt, services: servicesList });

              if (customerId) {
                const apptDateRaw =
                  fullAppt.AppointmentDate ||
                  new Date().toISOString().slice(0, 10);
                const dateStr = String(apptDateRaw).includes("T")
                  ? String(apptDateRaw).split("T")[0]
                  : String(apptDateRaw).slice(0, 10);
                const timeStr = fullAppt.StartTime || "10:00:00";
                ...
                const createRes = await axiosClient.post(
                  "/v2/treatment-notes",
                  {
                    ...
                    serviceId,
                    technicianId,
                    serviceDateTime: `${dateStr} ${timeStr.length === 5 ? timeStr + ":00" : timeStr}`,
                    status: "draft",
                  },
                );
                ...
                if (noteId) {
                  const fullRes = await axiosClient.get(
                    `/v2/treatment-notes/${noteId}`,
                  );
        ...
        if (!customerId) {
          ...
          const custs =
            custsRes.data?.data?.customers || custsRes.data?.data || [];
          if (custs.length > 0) {
        ...
        if (!customerId) {
          ...
          setServices(
            (await axiosClient.get("/services")).data?.data ||
              (await axiosClient.get("/services")).data ||
              [],
          );
          setEmployees(
            (await axiosClient.get("/employees")).data?.data ||
              (await axiosClient.get("/employees")).data ||
              [],
          );
          return;
        }
        ...
        let note = activeNote;
        if (!note && activeApptId && serviceIdParam) {
          note = hist.find(
            (n) =>
              String(n.appointment_id) === String(activeApptId) &&
              (String(n.service_id) === String(serviceIdParam) ||
                String(n.ServiceId) === String(serviceIdParam) ||
                String(n.AppointmentServiceId) === String(serviceIdParam)),
          );
        }
        if (!note && activeApptId && !serviceIdParam) {
          note = hist.find(
            (n) => String(n.appointment_id) === String(activeApptId),
          );
        }
        if (!note && !activeApptId && hist.length > 0) {
          note = hist[0];
        }

        if (!note && activeApptId && serviceIdParam && customerId) {
          try {
            ...
            const newNoteId = createRes.data?.data?.noteId;
            if (newNoteId) {
              const fullRes = await axiosClient.get(
                `/v2/treatment-notes/${newNoteId}`,
              );
              note = fullRes.data?.data;
            }
          } catch (err) {
            console.warn("Auto create note failed:", err.message);
          }
        }
  ...
  useEffect(() => {
    if (selectedNote?.customer_id) {
      axiosClient
        .get(`/technician/customers/${selectedNote.customer_id}`)
        .then((r) => {
  ...
  const initFields = (n) => {
    const svc = services.find(
      (s) => Number(s.ServiceId) === Number(n.service_id),
    );
    ...
    setEditRecs(
      n.recommendations
        ? Array.isArray(n.recommendations)
    ...
    setEditProducts(
      n.products_used?.length
        ? n.products_used.map((p) =>
            typeof p === "string"
              ? { name: p.split(" - ")[0] || p, desc: p.split(" - ")[1] || "" }
              : p,
          )
        : [],
    );
  ...
  const ktvList = useMemo(
    () => [...new Set(timeline.map((n) => n.TechnicianName).filter(Boolean))],
    [timeline],
  );
  const filtered = useMemo(() => {
    ...
    if (customer?.CustomerId) {
      list = list.filter(
        (n) => Number(n.customer_id) === Number(customer.CustomerId),
      );
    } else {
      list = [];
    }
    if (search)
      list = list.filter((n) =>
        [n.ServiceName, n.TechnicianName, n.CategoryName, n.CustomerName].some(
    ...
    if (filterSvc)
      list = list.filter(
        (n) =>
          n.CategoryName?.toLowerCase().includes(filterSvc.toLowerCase()) ||
          n.ServiceName?.toLowerCase().includes(filterSvc.toLowerCase()),
      );
    if (filterKtv) list = list.filter((n) => n.TechnicianName === filterKtv);
    if (filterStatus) list = list.filter((n) => n.status === filterStatus);
    if (filterStart)
      list = list.filter((n) => n.service_date_time >= filterStart);
    if (filterEnd)
      list = list.filter((n) => n.service_date_time <= filterEnd + "T23:59:59");
    return list;
  }, [
    timeline,
    customer,
  ...
  const isLockedNote = useMemo(() => {
    if (!selectedNote) return false;
    const stat = String(
      selectedNote.status || selectedNote.Status || "",
    ).toLowerCase();
    return (
      stat === "finalized" ||
      stat === "final" ||
      Boolean(selectedNote.is_locked)
    );
  }, [selectedNote]);
  ...
  const buildPayload = () => ({
    ...
    products_used: editProducts.map((p) =>
      typeof p === "object"
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await axiosClient.patch(
        `/v2/treatment-notes/${selectedNote.id}`,
        buildPayload(),
      );
  ...
  const handleFinalize = async () => {
    ...
    if (
      !window.confirm(
        "Sau khi KHÓA hồ sơ sẽ chuyển sang trạng thái chính thức. Bạn có chắc chắn muốn khóa hồ sơ này?",
      )
    )
      return;
    try {
      ...
      toast$(e.response?.data?.message || "Khóa thất bại.", "error");
    } finally {
      setSaving(false);
    }
  };
  ...
  const handleCustomerDeclines = async () => {
    ...
    if (
      !window.confirm(
        "Xác nhận khách hàng không có nhu cầu đặt lịch tái khám và muốn khóa hồ sơ điều trị này?",
      )
    )
      return;
    try {
      ...
      await axiosClient.post(`/v2/treatment-notes/${selectedNote.id}/finalize`);
      toast$(
        "Đã xác nhận: Khách hàng không muốn đặt lịch tái khám. Hồ sơ điều trị đã được khóa.",
      );
      setIsEditing(false);
      const d = await reloadTimeline();
      const u = d.find((n) => n.id === selectedNote.id);
  ...
  const openEditFollowUpModal = () => {
    ...
    const svcId =
      followUpApptDetail.ServiceId ||
      (followUpApptDetail.ServiceIds
        ? followUpApptDetail.ServiceIds.split(",")[0]
        : "");
    ...
    const ktvObj = employees.find(
      (e) => String(e.EmployeeId) === String(ktvId),
    );
    setBookKtvName(ktvObj?.FullName || "");
    setBookKtvAvatar(ktvObj?.AvatarUrl || "");
  ...
  const handleBook = async () => {
    if (!customer?.CustomerId) {
      toast$("Không xác định được khách hàng!", "error");
      return;
    }
    if (!bookDate) {
      toast$("Vui lòng chọn ngày hẹn!", "error");
      return;
    }
    if (!bookSvc) {
      toast$("Vui lòng chọn dịch vụ!", "error");
      return;
    }
    if (!bookKtv) {
      toast$("Vui lòng chọn kỹ thuật viên!", "error");
      return;
    }
    const today = new Date().toISOString().split("T")[0];
    if (bookDate < today) {
      toast$("Ngày hẹn không thể là ngày trong quá khứ!", "error");
      return;
    }
    if (suggestDate && !isEditingFollowUp) {
      ...
      if (bookDate < suggestDateStr) {
        toast$(
          `Ngày hẹn tái khám không thể trước ngày đề xuất tái khám (${suggestDate.toLocaleDateString("vi-VN")})!`,
          "error",
        );
        return;
      }
    ...
    try {
      setSaving(true);
      const pkgId =
        usePackage && selectedPackageId ? Number(selectedPackageId) : null;
      ...
      if (isEditingFollowUp && followUpApptId) {
        try {
          await axiosClient.delete(`/appointments/${followUpApptId}`, {
            data: {
              reason:
                "Cập nhật thay đổi thông tin đặt lịch tái khám từ Treatment Note",
            },
          });
        } catch (delErr) {
      ...
      const res = await axiosClient.post("/technician/appointments", {
        ...
        note:
          bookNote ||
          `Tái khám ${bookSvcName || selectedNote?.ServiceName || "dịch vụ"}`,
        ...
        status: "CONFIRMED",
        treatmentNoteId: selectedNote?.id ? selectedNote.id : undefined,
      });
      ...
      if (selectedNote && selectedNote.status !== "finalized") {
        try {
          ...
          await axiosClient.post(
            `/v2/treatment-notes/${selectedNote.id}/finalize`,
          );
          toast$("Đã tự động khóa hồ sơ điều trị!");
      ...
      toast$(
        isEditingFollowUp
          ...
          : `Đặt lịch tái khám thành công cho ${customer.FullName} ngày ${new Date(bookDate).toLocaleDateString("vi-VN")}!`,
        "success",
      );
      ...
      toast$(
        e.response?.data?.message || "Đặt lịch thất bại. Vui lòng thử lại.",
        "error",
      );
    } finally {
      setSaving(false);
  ...
  const openCreateNoteModal = async () => {
    try {
      ...
      const [resComp, resInProg] = await Promise.all([
        axiosClient.get("/technician/appointments", {
  ...
  const handleSelectCompletedAppt = async (appt) => {
    try {
      ...
      const detailRes = await axiosClient.get(
        `/technician/appointments/${appt.AppointmentId}`,
      );
      ...
      try {
        ...
        const findRes = await axiosClient.get(
          `/v2/treatment-notes/appointments/${appt.AppointmentId}?serviceId=${appt.ServiceId}`,
        );
      ...
      const custR = await axiosClient.get(
        `/technician/customers/${appt.CustomerId}`,
      );
      const custData = custR.data?.data;
      ...
      const match =
        d.find(
          (n) => String(n.id).toUpperCase() === String(note.id).toUpperCase(),
        ) || note;
      ...
      toast$(
        e.response?.data?.message || e.message || "Lỗi khởi tạo ghi chú.",
        "error",
      );
    } finally {
      setSaving(false);
  ...
  const handleShare = () => {
    ...
    const txt = [
      `🌸 LUNA SALON - HỒ SƠ DỊCH VỤ`,
      `👤 ${customer.FullName || "Trần Thanh Mai"}`,
      `💅 ${selectedNote.ServiceName}`,
      `📅 ${parseDateParts(selectedNote.service_date_time).full}`,
      `✅ Kết quả: ${editAfter}`,
      `📋 Khuyến nghị:\n${recsList.map((r) => `  • ${r}`).join("\n")}`,
    ].join("\n");
    navigator.clipboard
      .writeText(txt)
      .then(() => toast$("Đã sao chép thông tin dịch vụ!"));
  };
  ...
  const totalSpend = useMemo(() => {
    if (customer?.TotalSpent != null && customer.TotalSpent > 0)
      return fmtMoney(customer.TotalSpent);
  ...
  const visitsCount = useMemo(() => {
    if (customer?.TotalVisits != null && customer.TotalVisits > 0)
      return customer.TotalVisits;
  ...
  const getTimelineThumb = (item) => {
    ...
    // 1. Nail
    if (cat.includes("nail") || svc.includes("nail") || svc.includes("móng")) {
      if (svc.includes("cao cấp") || svc.includes("premium"))
        return svcImg("nail-premium.png");
      if (
        svc.includes("gel") ||
        svc.includes("hàn quốc") ||
        svc.includes("korean")
      )
        return svcImg("korean-gel.png");
      if (
        svc.includes("chăm sóc") ||
        svc.includes("care") ||
        svc.includes("dưỡng")
      )
        return svcImg("nail-care.png");
      return svcImg("nail.png");
    }

    // 2. Massage
    if (svc.includes("đá nóng") || svc.includes("hot stone"))
      return svcImg("hot-stone.png");
    if (
      svc.includes("vai") ||
      svc.includes("cổ") ||
      svc.includes("gáy") ||
      svc.includes("neck") ||
      svc.includes("shoulder")
    )
      return svcImg("neck-shoulder.png");
    if (
      cat.includes("massage") ||
      svc.includes("massage") ||
      svc.includes("thư giãn")
    ...
    // 3. Skincare / Facial
    if (svc.includes("mụn") || svc.includes("acne"))
      return svcImg("acne-care.png");
    if (
      svc.includes("trẻ hóa") ||
      svc.includes("trẻ hoá") ||
      svc.includes("chống lão hóa") ||
      svc.includes("anti-aging")
    )
      return svcImg("anti-aging.png");
    if (
      svc.includes("tinh chất") ||
      svc.includes("cấy") ||
      svc.includes("skin booster") ||
      svc.includes("booster")
    )
      return svcImg("skin-booster.png");
    if (
      cat.includes("skincare") ||
      cat.includes("facial") ||
      svc.includes("da mặt") ||
      ...
      if (svc.includes("cơ bản") || svc.includes("basic"))
        return svcImg("skincare-basic.png");
      return svcImg("skincare.png");
    }

    // 4. Hair
    if (svc.includes("nhuộm") || svc.includes("màu") || svc.includes("color"))
      return svcImg("hair-color.png");
    if (svc.includes("uốn") || svc.includes("curl"))
      return svcImg("hair-curl.png");
    if (svc.includes("phục hồi") || svc.includes("repair"))
      return svcImg("hair-repair.png");
    if (svc.includes("cắt") || svc.includes("tạo kiểu") || svc.includes("cut"))
      return svcImg("hair-cut.png");
    if (cat.includes("hair") || svc.includes("tóc") || svc.includes("gội"))
      return svcImg("hair.png");

    // 5. Detox / Slim
    if (svc.includes("detox") || svc.includes("body detox"))
      return svcImg("detox-body.png");
    if (
      svc.includes("giảm béo") ||
      svc.includes("slim") ||
      svc.includes("bụng")
    )
      return svcImg("slim-belly.png");

    // 6. Combo / Spa Combo
    if (
      svc.includes("tóc và nail") ||
      (svc.includes("tóc") && svc.includes("nail"))
    )
      return svcImg("hair-nail-combo.png");
    if (svc.includes("cuối tuần") || svc.includes("weekend"))
      return svcImg("weekend-combo.png");
    if (
      cat.includes("spa") ||
      svc.includes("spa") ||
      svc.includes("combo") ||
      svc.includes("package")
    )
      return svcImg("weekend-combo.png");
      ...
      <div className="tn-page">
        ...
        <div className="tn-header">
          <div className="tn-header__top-row">
            {appointmentId ? (
              ...
              >
                <span>←</span> Quay lại chi tiết lịch hẹn #{appointmentId}
              </button>
            ) : (
              <button
                className="tn-back"
                ...
                type="button"
              >
                <span className="tn-back-arrow">←</span> Quay lại
              </button>
            )}
            ...
            <div className="tn-header__actions">
              ...
              <button className="tn-btn tn-btn--dots" type="button">
                •••
              </button>
            </div>
          </div>
          <div className="tn-header__title-row" style={{ marginTop: "12px" }}>
            ...
            <p className="tn-header__sub">
              Hồ sơ ghi chú điều trị và chăm sóc của khách hàng
            </p>
          </div>
        </div>
            ...
            <div className="tn-profile-card__top">
              <div className="tn-profile-card__left">
                  ...
                  <img
                    ...
                    src={
                      customer?.AvatarUrl
                        ...
                        : `https://ui-avatars.com/api/?name=${encodeURIComponent(customer?.FullName || "Trần Thanh Mai")}&background=1f7a5a&color=fff&size=80`
                    }
                    alt={customer?.FullName || "Trần Thanh Mai"}
                    onError={(e) => {
                      e.target.src = `https://ui-avatars.com/api/?name=${encodeURIComponent(customer?.FullName || "Trần Thanh Mai")}&background=1f7a5a&color=fff&size=80`;
                    }}
                  />
                ...
                <div className="tn-profile-card__main-info">
                  <h2 className="tn-profile-card__name">
                    ...
                    <span style={{ fontSize: "1.1rem", marginLeft: "6px" }}>
                      👑
                    </span>
                  </h2>
                  <p className="tn-profile-card__code">
                    {customer?.CustomerCode ||
                      `#CUST-${String(customer?.CustomerId || 83).padStart(3, "0")}`}{" "}
                    · {customerAge} tuổi ·{" "}
                    {customer?.Gender === "Male" ? "Nam" : "Nữ"}
                  </p>
                  <p className="tn-profile-card__contact-item">
                    <span style={{ marginRight: "6px" }}>📞</span>
                    {customer?.Phone || "0901 234 567"}
                  </p>
                  <p className="tn-profile-card__contact-item">
                    <span style={{ marginRight: "6px" }}>✉</span>
                    {customer?.Email || "giakienkj1@gmail.com"}
                  </p>
              ...
              <div className="tn-profile-card__middle">
                ...
                <div className="tn-profile-card__stat-item">
                  ...
                  <span className="tn-pstat-trend tn-pstat-trend--up">
                    ↑ 12% so với 3 tháng trước
                  </span>
                  <svg
                    width="90"
                    height="20"
                    viewBox="0 0 100 24"
                    className="tn-pstat-spark"
                  >
                    <path
                      d="M 0 20 Q 20 18 40 12 T 80 4 T 100 2"
                      fill="none"
                      stroke="#22c55e"
                      strokeWidth="2.5"
                      strokeLinecap="round"
                    />
                    <path
                      d="M 0 20 Q 20 18 40 12 T 80 4 T 100 2 L 100 24 L 0 24 Z"
                ...
                <div className="tn-profile-card__stat-item">
                  ...
                  >
                    <path
                      d="M 0 20 C 20 22, 40 10, 60 14 C 80 18, 90 2, 100 4"
                      fill="none"
                      stroke="#22c55e"
                      strokeWidth="2.5"
                      strokeLinecap="round"
                    />
                    <path
                      d="M 0 20 C 20 22, 40 10, 60 14 C 80 18, 90 2, 100 4 L 100 24 L 0 24 Z"
                      fill="rgba(34, 197, 94, 0.08)"
                    />
                  </svg>
                </div>
                ...
                <div className="tn-profile-card__stat-item">
                  ...
                  >
                    <path
                      d="M 0 18 Q 25 24 50 14 T 75 10 T 100 6"
                      fill="none"
                      stroke="#eab308"
                      strokeWidth="2.5"
                      strokeLinecap="round"
                    />
                    <path
                      d="M 0 18 Q 25 24 50 14 T 75 10 T 100 6 L 100 24 L 0 24 Z"
              ...
              <div className="tn-profile-card__right">
                <div className="tn-profile-card__ktv-section">
                  <span className="tn-pcard-right-title">
                    KỸ THUẬT VIÊN PHỤ TRÁCH
                  </span>
                  <div className="tn-pcard-ktv-row">
                    <img
                      src={
                        selectedNote?.TechnicianAvatar
                      ...
                      onError={(e) => {
                        e.target.src = `https://ui-avatars.com/api/?name=${encodeURIComponent(selectedNote?.TechnicianName || "KTV")}&background=1f7a5a&color=fff&size=40&rounded=true`;
                      }}
                      style={{
                        width: "40px",
                        height: "40px",
                    ...
                    />
                    <div>
                      <strong className="tn-pcard-ktv-name">
                        {selectedNote?.TechnicianName || "—"}
                      </strong>
            ...
            <div className="tn-profile-card__bottom">
              ...
              <div className="tn-pcard-foot-item">
                ...
                <div className="tn-pcard-foot-content">
                  ...
                  <span className="tn-pcard-foot-status-badge">
                    Đang hoạt động
                  </span>
                </div>
              </div>
                  ...
                  >
                    {(() => {
                      ...
                      return Array.from({ length: 5 }).map((_, i) => (
                        <span
                          key={i}
                          style={{ color: i < count ? "#10b981" : "#d1d5db" }}
                        >
                          {i < count ? "💚" : "🤍"}
                        </span>
                      ));
              ...
              <button
                className="tn-pcard-foot-btn"
                onClick={() =>
                  navigate(
                    `/technician/customers?customerId=${customer?.CustomerId}`,
                  )
                }
                type="button"
              >
                Xem lịch sử chi tiết{" "}
                <span style={{ marginLeft: "4px", fontSize: "0.95rem" }}>
                  ›
                </span>
              </button>
              {/* <button 
                ...
                <div>
                  {loading && timeline.length === 0 ? (
                    [1, 2].map((i) => (
                      <div
                        key={i}
                        className="tn-tcard tn-tcard--skel"
                    ...
                    >
                      {(showAllDrafts
                        ...
                        return (
                          <div
                            key={item.id}
                            className={`tn-tcard ${active ? "tn-tcard--active" : ""}`}
                            onClick={() => selectNote(item)}
                            style={{ margin: 0, position: "relative" }}
                          >
                            {idx < arr.length - 1 && (
                              <div className="tn-tline" />
                            )}
                            <div
                              className={`tn-date ${active ? "tn-date--active" : ""}`}
                            >
                            ...
                            <div className="tn-tcard__body">
                              <div className="tn-tcard__row">
                                <strong className="tn-tcard__name">
                              ...
                              <p className="tn-tcard__meta">
                                💅 {item.ServiceName}
                              </p>
                              <p className="tn-tcard__meta">
                                ⏰{" "}
                                {formatTimeRange(
                                  item.service_date_time,
                      ...
                      {draftNotes.length > 5 && (
                        ...
                        >
                          {showAllDrafts
                            ? "▲ Thu gọn bản nháp"
                            : `👁 Xem tất cả bản nháp (${draftNotes.length})`}
                        </button>
                      )}
                    </div>
                  )}
                    ...
                    >
                      ...
                      {completedNotes.length > 5 && (
                        ...
                        >
                          {showAllCompleted
                            ? "▲ Thu gọn lịch sử"
                            : `👁 Xem tất cả lịch sử (${completedNotes.length})`}
                        </button>
                      )}
                    </div>
                  )}
            ...
            <div className="tn-search-section">
              ...
              <div className="tn-filter-row">
                ...
                >
                  ...
                  {[
                    ...new Set(
                      timeline.map((n) => n.CategoryName).filter(Boolean),
                    ),
                  ].map((c) => (
          ...
          <div className="tn-right">
            {!selectedNote ? (
              <div className="tn-detail-empty">
                ...
                <p>
                  Nhấn vào ca dịch vụ bên trái để hiển thị hồ sơ ghi chú đầy đủ.
                </p>
              </div>
            ) : (
              <div
              ...
              >
                ...
                <div className="tn-card">
                  <div className="tn-detail__head">
                    <div className="tn-detail__head-left">
                      <div className="tn-detail__head-title-row">
                        <h3 className="tn-detail__panel-label">
                          Chi tiết Treatment Note
                        </h3>
                        <span
                          className={
                            selectedNote.status === "finalized"
                              ? "tn-status-badge tn-status-badge--done"
                              : "tn-status-badge"
                          }
                          style={
                            selectedNote.status === "finalized"
                    ...
                    <div
                      className="tn-detail__head-actions"
                      style={{
                        display: "flex",
                        gap: "8px",
                        alignItems: "center",
                    ...
                    >
                      {isLockedNote ? (
                        ...
                        >
                          🔒 Hồ sơ đã KHÓA chính thức (Không thể chỉnh sửa)
                        </div>
                      ) : (
                        !isEditing && (
                          <button
                  ...
                  <div className="tn-detail__meta">
                    ...
                    <div className="tn-detail__meta-row">
                      ...
                      <span>
                        ⏰{" "}
                        {formatTimeRange(
                          selectedNote.service_date_time,
                          selectedNote.duration_minutes,
                        )}
                      </span>
                    ...
                    <div className="tn-detail__meta-row">
                      <span className="tn-ktv-inline">
                        <img
                          ...
                          src={
                            selectedNote.TechnicianAvatar ||
                            `https://ui-avatars.com/api/?name=${encodeURIComponent(selectedNote.TechnicianName || "Linh Chi")}&background=1f7a5a&color=fff&size=24`
                          }
                          alt=""
                          onError={(e) => {
                            e.target.src = `https://ui-avatars.com/api/?name=Linh+Chi&background=1f7a5a&color=fff&size=24`;
                          }}
                        />
                        KTV thực hiện:{" "}
                        <strong>{selectedNote.TechnicianName}</strong>
                      </span>
                      <span>
                        🔧 Dịch vụ: <strong>{selectedNote.ServiceName}</strong>
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="tn-ba">
                    <div className="tn-ba__col">
                      ...
                      <div
                        className="tn-ba__frame"
                        onClick={() =>
                          !isEditing &&
                          displayBeforeImg &&
                          setImgFull(displayBeforeImg)
                        }
                        style={{
                          cursor:
                            !isEditing && displayBeforeImg
                              ? "zoom-in"
                              : "default",
                        }}
                      >
                    ...
                    <div className="tn-ba__col">
                      ...
                      <div
                        ...
                        onClick={() =>
                          !isEditing &&
                          displayAfterImg &&
                          setImgFull(displayAfterImg)
                        }
                        style={{
                          cursor:
                            !isEditing && displayAfterImg
                              ? "zoom-in"
                              : "default",
                        }}
                      >
                  ...
                  <div className="tn-grid3">
                    <div className="tn-col3">
                      ...
                      >
                        <h4 className="tn-col3__title" style={{ margin: 0 }}>
                          Quy trình thực hiện
                        </h4>
                        {isEditing && (
                          <button
                      ...
                      {isEditing && (
                        <div className="tn-add">
                          <input
                            className="tn-add__input"
                            placeholder="Thêm bước..."
                            value={newStep}
                            onChange={(e) => setNewStep(e.target.value)}
                            onKeyDown={(e) => {
                              if (e.key === "Enter" && newStep.trim()) {
                                setEditSteps((p) => [...p, newStep.trim()]);
                                setNewStep("");
                              }
                            }}
                          />
                          <button
                            className="tn-add__btn"
                            onClick={() => {
                              if (newStep.trim()) {
                                setEditSteps((p) => [...p, newStep.trim()]);
                                setNewStep("");
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td className="tn-spec-val">
                              <span>{selectedNote.CategoryName || "—"}</span>
                            </td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            ...
                            <td className="tn-spec-val">
                              {isEditing ? (
                                <div>
                                  <input
                                    className="tn-spec-inp"
                                    value={editBefore}
                                    onChange={(e) =>
                                      setEditBefore(e.target.value)
                                    }
                                    placeholder="Nhập hoặc bấm chọn mẫu nhanh tình trạng ban đầu..."
                                    style={{
                                      width: "100%",
                                      marginBottom: "6px",
                                    }}
                                  ...
                                  >
                                    {getQuickBeforeSamples(
                                      ...
                                      <button
                                        ...
                                        title="Bấm để chọn mẫu nhanh này"
                                      >
                                        + {sample}
                                      </button>
                                    ))}
                              ...
                              {isEditing ? (
                                <div>
                                  <input
                                    ...
                                    value={editAfter}
                                    onChange={(e) =>
                                      setEditAfter(e.target.value)
                                    }
                                    placeholder="Nhập hoặc bấm chọn mẫu nhanh kết quả..."
                                    style={{
                                      width: "100%",
                                      marginBottom: "6px",
                                    }}
                          ...
                          <tr>
                            ...
                            <td className="tn-spec-val">
                              {isEditing ? (
                                ...
                                <span>
                                  {editDuration ? `${editDuration} phút` : "—"}
                                </span>
                              )}
                            </td>
                          </tr>
                          <tr>
                            ...
                            <td className="tn-spec-val">
                              <span>{selectedNote.TechnicianName || "—"}</span>
                            </td>
                          </tr>
                          <tr>
                            <td className="tn-spec-lbl">Chi phí dịch vụ</td>
                            <td className="tn-spec-val">
                              <span className="tn-price">
                                {fmtMoney(selectedNote.ServicePrice || 0)}
                              </span>
                            </td>
                          </tr>
                          <tr>
                ...
                >
                  ...
                  >
                    ...
                    >
                      <h3 className="tn-section__title" style={{ margin: 0 }}>
                    ...
                    {isEditing ? (
                      <textarea
                        ...
                        style={{ flex: 1 }}
                        value={editObserv}
                        onChange={(e) => setEditObserv(e.target.value)}
                  ...
                  >
                    ...
                    >
                      <h3 className="tn-section__title" style={{ margin: 0 }}>
                        Khuyến nghị &amp; Chăm sóc sau dịch vụ
                      </h3>
                      {isEditing && (
                        <button
                          type="button"
                    ...
                    {isEditing ? (
                      <textarea
                        ...
                        placeholder="Các khuyến nghị, cách nhau bằng dấu ;"
                      />
                    ) : (
                      <ul
                        className="tn-recs"
                      ...
                      >
                        {recsList.map((r, i) => (
                          ...
                          >
                            <span
                              className="tn-rec__tick"
                              style={{ color: "#10b981", fontWeight: "bold" }}
                            >
                              ✓
                            </span>
                            <span
                              className="tn-rec__txt"
                              style={{
                                fontSize: "0.85rem",
                ...
                >
                  ...
                  <div
                    className="tn-card tn-section"
                    style={{ margin: 0, borderBottom: "none", height: "100%" }}
                  >
                    <div
                      style={{
                        display: "flex",
                            ...
                            <input
                              ...
                              onChange={(e) => {
                                ...
                                if (detailedImgs.length + files.length > 6) {
                                  toast$(
                                    "Tổng số hình ảnh chi tiết không được vượt quá 6 hình ảnh!",
                                    "error",
                                  );
                                  return;
                                }
                    ...
                    {detailedImgs.length > 0 ? (
                      ...
                      >
                        {(detailedImgs || []).map((src, i) => (
                          <div
                            key={`d-${i}`}
                            className="tn-gallery__thumb"
                            style={{ position: "relative" }}
                          >
                            <img
                              src={resolveFileUrl(src)}
                              alt={`chi-tiet-${i + 1}`}
                              onClick={() => setImgFull(resolveFileUrl(src))}
                              style={{
                                width: "100%",
                                height: "90px",
                                objectFit: "cover",
                  ...
                  {(() => {
                    const isCombo = !!(
                      currentAppointment?.CustomerPackageId ||
                      selectedNote?.CustomerPackageId ||
                      selectedNote?.CustomerPackageName ||
                      selectedNote?.isCombo ||
                      (typeof selectedNote?.Notes === "string" &&
                        selectedNote.Notes.includes("[Gói Combo:")) ||
                      (typeof selectedNote?.notes === "string" &&
                        selectedNote.notes.includes("[Gói Combo:"))
                    );
                    ...
                    if (isCombo) {
                      return (
                        <div
                          className="tn-card tn-followup-card-wrapper"
                          style={{
                            margin: 0,
                            display: "flex",
                            flexDirection: "column",
                        ...
                        >
                          ...
                          <b style={{ color: "#831843", fontSize: "1rem" }}>
                            Gói Combo Trọn Gói
                          </b>
                          <p
                            style={{
                          ...
                          >
                            Lịch hẹn này thuộc gói Combo của khách hàng.
                            <br />
                            Khách hàng sẽ tự chọn ngày và đặt lịch các buổi tiếp
                            theo trên tài khoản của mình. Không có lịch tái khám
                            lẻ.
                          </p>
                        </div>
                      );
                    ...
                    if (selectedNote.follow_up_appointment_id) {
                      return (
                        ...
                        >
                          ...
                          >
                            Lịch tái khám đã được đặt
                          </p>
                          {followUpApptDetail ? (
                            <div
                              className="tn-followup__main"
                              style={{ display: "flex", gap: "12px" }}
                            >
                              <div
                                className="tn-followup__date"
                                style={{ background: "#3b82f6" }}
                              >
                                <span className="tn-fdate__day">
                                  {getDayOfWeekVn(
                                    new Date(
                                      followUpApptDetail.AppointmentDate,
                                    ),
                                  )}
                                </span>
                                <span className="tn-fdate__num">
                                  {pad(
                                    new Date(
                                      followUpApptDetail.AppointmentDate,
                                    ).getDate(),
                              ...
                              <div className="tn-followup__info">
                                <strong>
                                  {followUpApptDetail.ServiceName ||
                                    selectedNote.ServiceName}
                                </strong>
                                <p
                                  style={{
                                ...
                                >
                                  ⏰{" "}
                                  {formatTime(followUpApptDetail.StartTime) ||
                                    "10:00"}{" "}
                                  (CN {followUpApptDetail.BranchId || 1})
                                </p>
                                <p
                                  style={{
                                    margin: "2px 0",
                                ...
                                >
                                  👤 KTV:{" "}
                                  {followUpApptDetail.EmployeeName ||
                                    selectedNote.TechnicianName}
                                </p>
                                <p
                                  style={{
                                ...
                                >
                                  ...
                                  <strong
                                    style={{
                                      color:
                                        followUpApptDetail.Status ===
                                        "CONFIRMED"
                                          ? "#16a34a"
                                          : "#d97706",
                                    }}
                                  >
                                    {followUpApptDetail.Status === "CONFIRMED"
                                      ? "Đã xác nhận"
                                      : "Chờ xác nhận"}
                                  </strong>
                                </p>
                          ...
                          >
                            {selectedNote.status === "finalized" ? (
                              ...
                              >
                                🔒 Hồ sơ điều trị đã khóa.
                                <br />
                                Không thể chỉnh sửa lịch tái khám.
                              </div>
                            ) : (
                              <button
                                className="tn-btn tn-btn--sm"
                                onClick={openEditFollowUpModal}
                                type="button"
                                style={{
                                  justifyContent: "center",
                                  width: "100%",
                        ...
                        >
                          ...
                          >
                            <div className="tn-followup__date">
                              <span className="tn-fdate__day">
                                {getDayOfWeekVn(suggestDate)}
                              </span>
                              <span className="tn-fdate__num">
                                {pad(suggestDate.getDate())}
                              </span>
                              <span className="tn-fdate__mo">
                                TH{pad(suggestDate.getMonth() + 1)}
                              </span>
                              <span className="tn-fdate__yr">
                                {suggestDate.getFullYear()}
                              </span>
                            </div>
                            <div className="tn-followup__info">
                              ...
                              >
                                👤 KTV: {selectedNote.TechnicianName}
                              </p>
                              <p
                                style={{
                                  margin: "2px 0",
                          ...
                          >
                            {selectedNote.status === "finalized" ? (
                              ...
                              >
                                🔒 Hồ sơ điều trị đã khóa.
                                <br />
                                Không thể đặt lịch tái khám.
                              </div>
                            ) : selectedNote.AppointmentStatus ===
                              "COMPLETED" ? (
                              <>
                                <button
                                  ...
                                  onClick={() => {
                                    const y = suggestDate.getFullYear(),
                                      m = suggestDate.getMonth() + 1,
                                      d = suggestDate.getDate();
                                    setBookDate(`${y}-${pad(m)}-${pad(d)}`);
                                    setBookDateLocked(true);
                                    setBookSvc(
                                      String(selectedNote.service_id || ""),
                                    );
                                    setBookSvcName(
                                      selectedNote.ServiceName || "",
                                    );
                                    ...
                                    setBookKtv(
                                      String(selectedNote.technician_id || ""),
                                    );
                                    setBookKtvName(
                                      selectedNote.TechnicianName || "",
                                    );
                              ...
                              >
                                ⚠️ Chỉ đặt lịch tái khám khi lịch gốc đã hoàn
                                thành. (Hiện tại:{" "}
                                {selectedNote.AppointmentStatus === "CONFIRMED"
                                  ? "Đã xác nhận"
                                  : selectedNote.AppointmentStatus === "PENDING"
                                    ? "Chờ xác nhận"
                                    : selectedNote.AppointmentStatus ===
                                        "CHECKED_IN"
                                      ? "Đã check-in"
                ...
                {isAdmin && (
                  <div
                    className="tn-card tn-section"
                    style={{ borderBottom: "none", marginBottom: "16px" }}
                  >
                    <h3
                      className="tn-section__title tn-section__title--admin"
                      style={{ margin: "0 0 12px" }}
                    >
                      🔒 Ghi chú nội bộ <small>(Admin/Manager)</small>
                    </h3>
                    {isEditing ? (
                      <textarea
                        className="tn-textarea"
                        ...
                        placeholder="Ghi chú bảo mật nội bộ..."
                      />
                    ) : (
                      <p className="tn-admin-txt" style={{ margin: 0 }}>
                        {editInternal || "Không có ghi chú nội bộ."}
                      </p>
                    )}
                  </div>
                )}
                ...
                {isEditing && (
                  ...
                  >
                    <button
                      className="tn-btn tn-btn--success"
                      onClick={handleSave}
                      disabled={saving}
                      type="button"
                    >
                    ...
                    {(() => {
                      const apptStatus = String(
                        selectedNote?.AppointmentStatus ||
                          selectedNote?.appointment_status ||
                          currentAppointment?.Status ||
                          "",
                      ).toUpperCase();
                      const noteSvcId =
                        selectedNote?.service_id ||
                        selectedNote?.ServiceId ||
                        selectedNote?.AppointmentServiceId;
                      const currentServiceStep =
                        currentAppointment?.services?.find(
                          (s) =>
                            String(s.ServiceId) === String(noteSvcId) ||
                            String(s.AppointmentServiceId) ===
                              String(noteSvcId),
                        );
                      const svcStepStatus = String(
                        currentServiceStep?.StepStatus ||
                          selectedNote?.StepStatus ||
                          selectedNote?.step_status ||
                          selectedNote?.ServiceStatus ||
                          "",
                      ).toUpperCase();

                      const isCompleted =
                        apptStatus === "COMPLETED" ||
                        svcStepStatus === "COMPLETED";

                      return (
                        <button
                          className="tn-btn tn-btn--lock"
                          ...
                          title={
                            !isCompleted
                              ? "Chỉ được khóa hồ sơ khi bước dịch vụ này hoặc toàn bộ ca hẹn đã hoàn thành"
                              : "Khóa chính thức hồ sơ phác đồ trị liệu"
                          }
                        >
                          🔒 Khóa hồ sơ{" "}
                          {!isCompleted && "(Yêu cầu hoàn thành dịch vụ)"}
                        </button>
                      );
                    })()}
                ...
                <div
                  className="tn-card tn-bot-bar"
                  style={{ borderBottom: "none" }}
                >
                  <button
                    className="tn-bot-btn"
                    onClick={() =>
                      toast$("Đã gửi hướng dẫn chăm sóc qua Zalo/SMS!")
                    }
                    type="button"
                  >
            ...
            >
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  ...
                  >
                    {isEditingFollowUp
                      ? "Cập nhật lại thời gian và dịch vụ tái khám"
                      : "Lên lịch để chúng tôi tiếp tục chăm sóc bạn tốt nhất"}
                  </p>
                </div>
                <button
              ...
              <div style={{ display: "flex", flex: 1, minHeight: 0 }}>
                ...
                >
                      ...
                      >
                        <img
                          src={
                            customer?.AvatarUrl
                              ? resolveFileUrl(customer.AvatarUrl)
                              : `https://ui-avatars.com/api/?name=${encodeURIComponent(customer?.FullName || "KH")}&background=1f7a5a&color=fff&size=96`
                          }
                          alt={customer?.FullName || "KH"}
                          onError={(e) => {
                            e.target.src = `https://ui-avatars.com/api/?name=${encodeURIComponent(customer?.FullName || "KH")}&background=1f7a5a&color=fff&size=96`;
                          }}
                          style={{
                            width: 48,
                            height: 48,
                  ...
                  <div style={{ marginBottom: 24 }}>
                    ...
                    >
                      ...
                      <input
                        ...
                        min={(() => {
                          ...
                          if (suggestDate) {
                            ...
                            const y = suggestDate.getFullYear();
                            const m = String(
                              suggestDate.getMonth() + 1,
                            ).padStart(2, "0");
                            const d = String(suggestDate.getDate()).padStart(
                              2,
                              "0",
                            );
                            const suggestDateStr = `${y}-${m}-${d}`;
                      ...
                      {bookDate && (
                        ...
                        >
                          {new Date(bookDate + "T00:00:00").toLocaleDateString(
                            "vi-VN",
                            {
                              weekday: "long",
                              day: "2-digit",
                    ...
                    {slotLoading ? (
                      ...
                      >
                        {availableSlots.map((slot) => {
                          ...
                          const isActive =
                            formatTime(bookTime) === formattedStart;
                          return (
                            <button
                              key={slot.startTime}
                              type="button"
                      ...
                      >
                        💡 Vui lòng chọn kỹ thuật viên và ngày để xem giờ trống.
                      </p>
                    )}
                          ...
                          {alternatives.map((alt, idx) => (
                            <button
                              ...
                              onClick={() => {
                                ...
                                if (alt.startTime)
                                  setBookTime(formatTime(alt.startTime));
                              }}
                              style={{
                                padding: "4px 8px",
                                borderRadius: 6,
                  ...
                  <div style={{ marginBottom: 24 }}>
                    ...
                    >
                      ...
                      {(() => {
                        const svc = services.find(
                          (s) => String(s.ServiceId) === String(bookSvc),
                        );
                        return svc?.Price ? (
                          <span
                            style={{
                          ...
                          .filter(
                            (item) =>
                              ...
                              item.FullName?.toLowerCase().includes(
                                ktvKeyword.toLowerCase(),
                              ),
                          )
                          .map((item) => {
                            const isSelected =
                              String(bookKtv) === String(item.EmployeeId);
                            return (
                              <button
                                type="button"
                                key={item.EmployeeId}
                                ...
                                <img
                                  src={
                                    item.ImageUrl
                                      ...
                                      : `https://ui-avatars.com/api/?name=${encodeURIComponent(item.FullName || "KTV")}&background=1f7a5a&color=fff&size=64`
                                  }
                                  alt={item.FullName}
                                  onError={(e) => {
                                    e.target.src = `https://ui-avatars.com/api/?name=${encodeURIComponent(item.FullName || "KTV")}&background=1f7a5a&color=fff&size=64`;
                                  }}
                                  style={{
                                    width: 32,
                                    height: 32,
                          ...
                          >
                            {matchedPackages.map((pkg) => (
                              <option
                                ...
                                value={pkg.CustomerPackageId}
                              >
                                {pkg.PackageName} (Còn {pkg.RemainingSessions}{" "}
                                buổi)
                              </option>
                            ))}
                          </select>
                ...
                >
                    ...
                    >
                      ...
                      >
                        <img
                          ...
                          alt={customer?.FullName || "KH"}
                          onError={(e) => {
                            e.target.src = `https://ui-avatars.com/api/?name=${encodeURIComponent(customer?.FullName || "KH")}&background=1f7a5a&color=fff&size=64`;
                          }}
                          style={{
                            width: 32,
                            height: 32,
                      ...
                      >
                        <img
                          ...
                          alt={bookKtvName || "KTV"}
                          onError={(e) => {
                            e.target.src = `https://ui-avatars.com/api/?name=${encodeURIComponent(bookKtvName || "KTV")}&background=1f7a5a&color=fff&size=64`;
                          }}
                          style={{
                            width: 32,
                            height: 32,
                            ...
                            >
                              {usePackage
                                ...
                                : (() => {
                                    const svc = services.find(
                                      (s) =>
                                        String(s.ServiceId) === String(bookSvc),
                                    );
                                    return svc?.Price
                  ...
                  >
                    🌿 Tái khám giúp duy trì kết quả và chăm sóc tốt nhất cho
                    bạn. 💚
                  </div>
                  ...
                  {(() => {
                    ...
                    timeline
                      .filter(
                        (n) =>
                          customer?.CustomerId &&
                          Number(n.customer_id) === Number(customer.CustomerId),
                      )
                      .sort(
                        (a, b) =>
                          parseLocalDate(b.service_date_time) -
                          parseLocalDate(a.service_date_time),
                      )
                      .forEach((n) => {
                        const dateStr = n.service_date_time
                          ? parseLocalDate(
                              n.service_date_time,
                            ).toLocaleDateString("vi-VN")
                          : "";
                                ...
                                >
                                  {svcImage ? (
                                    <img
                                      ...
                                      onError={(e) => {
                                        e.target.src = `https://ui-avatars.com/api/?name=${encodeURIComponent(note.ServiceName || "DV")}&background=1f7a5a&color=fff&size=64`;
                                      }}
                                      style={{
                                        width: 38,
                                        height: 38,
                                    ...
                                    >
                                      ...
                                      {note.TechnicianName && (
                                        ...
                                        >
                                          ...
                                          <img
                                            src={
                                              note.TechnicianAvatar
                                                ? resolveFileUrl(
                                                    note.TechnicianAvatar,
                                                  )
                                                : `https://ui-avatars.com/api/?name=${encodeURIComponent(note.TechnicianName)}&background=1f7a5a&color=fff&size=32`
                                            }
                                            alt={note.TechnicianName}
                                            onError={(e) => {
                                              e.target.src = `https://ui-avatars.com/api/?name=${encodeURIComponent(note.TechnicianName)}&background=1f7a5a&color=fff&size=32`;
                                            }}
                                            style={{
                                              width: 16,
                                              height: 16,
        ...
        {showCreateNoteModal && (
          <div
            className="tn-modal-bg"
            onClick={(e) =>
              e.target === e.currentTarget && setShowCreateNoteModal(false)
            }
          >
            <div className="tn-modal" style={{ width: "520px" }}>
              ...
              <p className="tn-modal__sub">
                Chọn lịch hẹn đã hoàn thành hoặc đang thực hiện để tiến hành ghi
                chú
              </p>
              ...
              >
                {loadingAppts ? (
                  ...
                  >
                    Không có lịch hẹn hoàn thành hoặc đang thực hiện nào cần ghi
                    chú.
                  </p>
                ) : (
                  completedAppts.map((appt) => (
                    ...
                    >
                      ...
                      <button
                        className="tn-btn tn-btn--primary tn-btn--sm"
                        onClick={() => handleSelectCompletedAppt(appt)}
                        type="button"
                      >
                        Chọn
                      </button>
